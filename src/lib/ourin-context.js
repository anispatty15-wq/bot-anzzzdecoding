...
function _saluranCtx() {
  const saluranId = config.saluran?.id || "https://whatsapp.com/channel/0029VaeuHmG5fM5bcY99wS0T@newsletter";
  const saluranName = config.saluran?.name || config.bot?.name || "anzzzdecoding";
  return {
    forwardingScore: 9,
    isForwarded: true,
