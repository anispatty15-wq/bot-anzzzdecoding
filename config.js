...
const config = {
  ...
  owner: {
    name: "anzzz", // Nama owner
    number: ["6281338838631"], // Format: 628xxx (tanpa + atau 0)
  },
  ...
  bot: {
    name: 'anzzzdecoding', // Nama bot
    version: "3.2.0", // Versi bot
    developer: "anzzz", // Nama developer
  },
  ...
  vercel: {
    ...
    token: "MAHIRU BOT", // Vercel Token untuk fitur deploy ( Kalau .deploy mau work, ini wajib di isi )
  },

  payment: {
    qrisUrl: "",
    methods: [
      { name: "Dana", number: "6281338838631", holder: "" },
      { name: "GoPay", number: "", holder: "" },
      { name: "OVO", number: "", holder: "" },
      { name: "ShopeePay", number: "", holder: "" },
    ],
    banks: [],
    customText: "https://whatsapp.com/channel/0029VaeuHmG5fM5bcY99wS0T",
  },

  donasi: {
    payment: [
      { name: "Dana", number: "81338838631", holder: "Anzzz" },
      { name: "GoPay", number: "81338838631", holder: "Anzzz" },
      { name: "OVO", number: "81338838631", holder: "Anzzz" },
    ],
    links: [
      { name: "Saweria", url: "saweria.co/anzzzsenpai" },
    ...
    qris: "https://whatsapp.com/channel/0029VbDNMQ7IyPtNrQB4pJ33",
  },
  ...
  sticker: {
    packname: "anzzzdecoding", // Nama pack sticker
    author: "anzzz", // Author sticker
  },

  saluran: {
    id: "0029VaeuHmG5fM5bcY99wS0T@newsletter", // ID saluran (contoh: 120363xxx@newsletter)                          // ID saluran (contoh: 120363xxx@newsletter)
    name: "WHATSAPP BOT MULTI DEVICE", // Nama saluran
    link: "https://whatsapp.com/channel/0029VaeuHmG5fM5bcY99wS0T", // Link saluran
  },
  ...
  messages: {
    ...
    rejectCall: "🚫 JANGAN TELPON NOMOR INI WEH INI NOMOR BOT ATAU AI",
  },
