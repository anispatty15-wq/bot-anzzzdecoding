...
async function handler(m, { sock, db }) {
  ...
  if (!categoryArg) {
    ...
    let modeExcludeMap = {
      ...
      store: ["panel", "pushkontak", "jpm", "ephoto", "cpanel", "store_autoorder"],
      autoorder: ["panel", "pushkontak", "jpm", "ephoto", "cpanel", "store"],
      pushkontak: ["panel", "store", "jpm", "ephoto", "cpanel", "store_autoorder"],
      cpanel: ["pushkontak", "store", "jpm", "ephoto", "store_autoorder"],
    };
